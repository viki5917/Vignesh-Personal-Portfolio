        ...
        <main className="contact-row">
          <section className="col left">
            ...
            <div className="socialMedia">
              <a href="https://www.facebook.com/vignesh71214/" target="_blank">
                <FontAwesomeIcon
                  className="fa-brands fa-facebook-f"
                  icon={faFacebookF}
                />
              </a>
              <a href="https://www.instagram.com/viki.3208/" target="_blank">
                <FontAwesomeIcon
                  className="fa-brands fa-instagram"
                  icon={faInstagram}
                />
              </a>
              <a href="https://github.com/viki5917" target="_blank">
                <FontAwesomeIcon
              ...
              <a
                href="https://linkedin.com/in/vignesh-s-9a1802222"
                target="_blank"
              >
                <FontAwesomeIcon
          ...
          <section className="col right">
            ...
            >
              ...
              <div className="inputGroup fullWidth inputGroup-button">
                ...
                <a
                  href="Vignesh S FullStack Resume.pdf"
                  download="Vignesh S FullStack Resume.pdf"
                >
                  Download CV
                </a>
              </div>
